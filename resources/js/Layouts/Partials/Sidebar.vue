            ...
            <div class="h-full pt-3 pb-8" data-simplebar>
                <ul class="nk-menu">
                    ...
                    <template v-if="$page.props.auth.user && hasAnyPermission(['utilisateurs.gerer', 'parametres.gerer', 'branding.gerer'])">
                        ...
                        <!-- Pack Premium / Abonnement (Tenant View) -->
                        <li v-if="['admin', 'secretaire'].includes($page.props.auth.user.type)"
                            :class="['nk-menu-item py-0 group/item', { 'active': route().current('admin.subscription') }]">
                            <Link :href="route('admin.subscription')"
                                class="nk-menu-link flex relative items-center align-middle py-2 ps-5 pe-8 font-heading font-bold tracking-snug group">
                                <span
                                    class="font-normal tracking-normal w-8 inline-flex flex-grow-0 flex-shrink-0 text-slate-400 group-[.active]/item:text-primary-500 group-hover:text-primary-500">
                                    <em
                                ...
                                <span
                                    class="group-[&.is-compact:not(.has-hover)]/sidebar:opacity-0 flex-grow-1 inline-block whitespace-nowrap transition-all duration-300 text-sm text-slate-600 dark:text-slate-500 group-[.active]/item:text-primary-500 group-hover:text-primary-500">Mon Abonnement</span>
                            </Link>
                        </li>
                        ...
                        <li v-if="['superadmin', 'admin'].includes($page.props.auth.user.type)"
                            ...
                            <Link :href="route('admin.partenaires.recap')"
                                class="nk-menu-link flex relative items-center align-middle py-2 ps-5 pe-8 font-heading font-bold tracking-snug group">
                                <span
                                    class="font-normal tracking-normal w-8 inline-flex flex-grow-0 flex-shrink-0 text-slate-400 group-[.active]/item:text-pink-500 group-hover:text-pink-500">
                                    <em
                                        class="text-xl leading-none text-current transition-all duration-300 icon ni ni-users"></em>
                                </span>
                                <span
                                    class="group-[&.is-compact:not(.has-hover)]/sidebar:opacity-0 flex-grow-1 inline-block whitespace-nowrap transition-all duration-300 text-sm text-slate-600 dark:text-slate-500 group-[.active]/item:text-pink-500 group-hover:text-pink-500 font-bold">Récap.
                                    Partenaires</span>
                            </Link>
                        </li>
                        ...
                        <li v-if="$page.props.auth.user.type === 'superadmin'" :class="['nk-menu-item py-0 group/item', { 'active': route().current('admin.logs.viewer') }]">
                            <Link :href="route('admin.logs.viewer')"
                                ...
                                <span
                                    class="font-normal tracking-normal w-8 inline-flex flex-grow-0 flex-shrink-0 text-slate-400 group-[.active]/item:text-primary-500 group-hover:text-primary-500">
                                    <em
                                        class="text-xl leading-none text-current transition-all duration-300 icon ni ni-reports"></em>
                                </span>
                                <span
