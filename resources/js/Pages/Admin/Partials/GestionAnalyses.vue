<template>
    <div>
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 mb-8">
            <div>
                <h1 class="text-2xl font-heading font-bold text-gray-900 dark:text-white">Catalogue des Analyses</h1>
                <p class="text-gray-600 dark:text-gray-400 mt-1 text-sm">Gérez et configurez les analyses du laboratoire</p>
            </div>
        </div>
...
const applyFilters = () => router.get(route('dashboard'), form.value, { preserveState: true, preserveScroll: true, replace: true });
