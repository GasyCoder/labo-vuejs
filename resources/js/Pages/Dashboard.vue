...
<AppLayout>
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-2 sm:space-y-0 mb-6">
        <h2 class="font-heading font-semibold text-xl sm:text-2xl text-gray-900 dark:text-gray-100">
            Tableau de bord - {{ $page.props.auth.user.name }}
        </h2>
        ...
        <div class="mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-gradient-to-r from-primary-500 to-primary-600 rounded-lg shadow-lg p-6 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        <h3 class="text-lg font-semibold">Bienvenue, {{ $page.props.auth.user.name }}</h3>
                        <p class="text-primary-100">{{ capitalizeFirstLetter($page.props.auth.user.type) }} - Tableau de bord</p>
                    </div>
                    <div class="text-4xl">
                        <template v-if="$page.props.auth.user.type === 'superadmin'">⚙️</template>
                        <template v-else-if="$page.props.auth.user.type === 'biologiste'">🔬</template>
                        <template v-else-if="$page.props.auth.user.type === 'technicien'">🧪</template>
                        <template v-else-if="$page.props.auth.user.type === 'secretaire'">📋</template>
                    </div>
                </div>
            </div>
                                ...
                                <div class="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p class="text-xl font-bold text-green-900 dark:text-green-100">
                                            {{ formatCurrency(stats.finances?.recettes_jour) }} Ar
                                        </p>
                                    </div>
                                    <div
                                        class="w-8 h-8 bg-green-100 dark:bg-green-800 rounded-full flex items-center justify-center">
                                ...
                                <div class="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p class="text-xl font-bold text-blue-900 dark:text-blue-100">
                                            {{ formatCurrency(stats.finances?.recettes_mois) }} Ar
                                        </p>
                                    </div>
                                    <div
                                        class="w-8 h-8 bg-blue-100 dark:bg-blue-800 rounded-full flex items-center justify-center">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                ...
                <div class="p-6">
                    <div class="space-y-3">
                        <template v-if="stats.activites && stats.activites.length > 0">
                            <div v-for="(activite, index) in stats.activites" :key="index" class="flex items-start space-x-3">
                                <div
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <template v-if="hasPermission('analyses.valider')">
                        ...
                        <template v-if="hasPermission('analyses.effectuer')">
