...
if (document.readyState === 'complete') {
  ...
  window.addEventListener('load', initLayoutUi, { once: true });
}
...
if (!window.__inertiaLayoutUiRebind) {
  window.__inertiaLayoutUiRebind = true;
  window.addEventListener('ui:inertia-success', function () {
    initLayoutUi();
  });
}
