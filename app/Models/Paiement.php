...
class Paiement extends Model
{
    ...
    public static function recalculerCommissionsMensuelles($paiement)
    {
        ...
        static::recalculerPourPrescripteur($prescripteur, $date);
    }

    /**
     * Recalculer toutes les commissions d'un prescripteur pour un mois donné
     */
    public static function recalculerPourPrescripteur($prescripteur, $date = null)
    {
        if (! $prescripteur) {
            return;
        }
